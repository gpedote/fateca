...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
										<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SystemRule.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SystemRule.id'))); ?></li>
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="systemRules form">
			...
			<?php echo $this->Form->create('SystemRule', array('inputDefaults' => array('label' => false), 'role' => 'form')); ?>
				<fieldset>
					<h2><?php echo __('Edit System Rule'); ?></h2>
