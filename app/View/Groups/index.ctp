...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Html->link(__('New Group'), array('action' => 'add'), array('class' => '')); ?></li>						<li class="list-group-item"><?php echo $this->Html->link(__('List People'), array('controller' => 'people', 'action' => 'index'), array('class' => '')); ?></li> 
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="groups index">
			...
			<h2><?php echo __('Manage Groups'); ?></h2>
...
<?php foreach ($groups as $group): ?>
	<tr>
		<td><?php echo h($group['Group']['name']); ?>&nbsp;
			...
			<?php if ($group['Group']['name'] === $defaultGroup) : ?>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Permissions'), array('controller' => 'groups', 'action' => 'permissions', $group['Group']['id']), array('class' => 'btn btn-default btn-xs')); ?>
